...
public enum UIElementType {
    ...
    FORM, INPUT_HIDDEN, INPUT_TEXT, INPUT_TEXTAREA, INPUT_RADIO_BUTTON, INPUT_SELECT, INPUT_SELECT_OPTION, INPUT_BUTTON, INPUT_SUBMIT, INPUT_RESET, INPUT_IMAGE, INPUT_FILE, INPUT_PASSWORD,
